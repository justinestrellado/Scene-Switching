...
public class Third : SEScene
{
	...
	public void initialize(SEResourceCache rsc) {
		base.initialize(rsc);
			...
			rsc.prepare_image("stallone", "sylvester", get_scene_width()*0.5,get_scene_height()*0.65);
			rsc.prepare_font("myfont", "arial bold color=#000000", 80);
			
			mainscene = add_sprite_for_image(SEImage.for_resource("main"));
			looney = add_sprite_for_image(SEImage.for_resource("stallone"));
			text = add_sprite_for_text("Third Scene", "myfont");
